...
<html lang="en">
	...
	<body>
		...
		<div class="resend-password-wrapper" style="margin-left:500px;">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<form id="resend_password_form" class="clearfix resend-password js-resend-password" method="post" action="newPasswordLinkDonor.php">
			...
			<?php if(isset($_SESSION['FORGOT_PASSWORD_EMAIL_DONOR_NOT_EXISTS'])) { ?>
