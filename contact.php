	  			...
	  			<div class="container">
	  				...
	  				<div class="nav-collapse collapse">
	  					<ul class="nav nav-tabs">
	  						<li><a class="brand" href="index.php">Sampark</a></li>
	  					...
	  					<div align="center" class="nav-collapse collapse" style="margin:10px">
	  						<ul class="nav">
	  							<form class="form-search">
	  								<input type="text" class="span5 search-query" style="margin:10px" placeholder="Search for NGO"/>
	  								<div class="dropdown">
			...
			<table class="table table-bordered">
				<thead>
				  <tr>
					...
					<th class="span4">Team mentor name</th>
					<th class="span4">Email</th>
					<th class="span4">Contact Number</th>
					<th>Webpage</th>
				  </tr>
				</thead>
				<tbody>
			...
			<table class="table table-bordered">
				<thead>
				  <tr>
					...
					<th class="span4">Developing Team members</th>
					<th class="span4">Email</th>
					<th class="span4">Contact Number</th>
					<th>Webpage</th>
				  </tr>
				...
				<tbody>
					...
					<tr>
						<td>Ronit Patel</td>
						<td>ronitmutd.patel@gmail.com</td>
						<td>+91-9825999972</td>
						<td></td>
					</tr>
					
					<tr>
						<td>Vijay Dhameliya</td>
						<td>vijay.atwork13@gmail.com</td>
						<td>+91-8141006510</td>
						<td></td>
					</tr>+
					...
					<tr>
						<td>Raj Buddhdev</td>
						<td>buddhdev.raj34@gmail.com</td>
						<td>+91-7359309891</td>
						<td></td>
					</tr>
					...
					<tr>
						<td>Sanket Jain</td>
						<td>sanketjain5984@gmail.com</td>
						<td>+91-9624264342</td>
						<td></td>
					</tr>
					...
					<tr>
						<td>Ronak Kothari</td>
						<td>ronakkothari301@gmail.com</td>
						<td>+91-7567249636</td>
						<td></td>
					</tr>
					...
					<tr>
						<td>Achint Mehta</td>
						<td>achintjmehta93@gmail.com</td>
						<td>+91-7405755993</td>
						<td></td>
					</tr>
