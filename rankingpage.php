	  			...
	  			<div class="container">
	  				...
	  				<div class="nav-collapse collapse">
	  					<ul class="nav nav-tabs">
	  						...
	  						<li class="active"><a href="rankingpage.php">Top Organizations</a></li>
	  					...
	  					<div align="center" class="nav-collapse collapse" style="margin:10px">
	  						<ul class="nav">
	  							<form class="form-search">
	  								<input type="text" class="span4 search-query" style="margin:10px" placeholder="Search for NGO"/>
	  								<div class="dropdown">
	  					...
	  					<ul class="nav pull-right" style="margin-top:9px">
							<input type="button" class="btn btn-success" name="signupButton" value="Create Account" id="signup" data-toggle="modal" style="margin:10px" data-target="#signupModal">	
